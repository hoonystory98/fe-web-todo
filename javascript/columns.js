...
window.onload = function(){
    init.Column.forEach(Column=>{
        ...
        ColumnCards.forEach(Card=>{
            ...
            let CardHTML=`<div class="ColumnCards" id="${Column.ID}-${Card.CardID}">
            ...
            console.log(document.getElementById(`${Column.ID}-${Card.CardID}`))
            document.getElementById(`${Column.ID}-${Card.CardID}`).addEventListener("dblclick",CardModifying);
        });
    });
}